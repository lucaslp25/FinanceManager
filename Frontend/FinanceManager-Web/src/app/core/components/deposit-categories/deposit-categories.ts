...
import { DepositCategoryResponseDTO } from '../../services/deposit-category-service';

@Component({
  selector: 'app-deposit-categories',
  imports: [Modal, ReactiveFormsModule],
  templateUrl: './deposit-categories.html',
  styleUrl: './deposit-categories.scss',
})
export class DepositCategories implements OnInit{

  public state = inject(DepositCategoryState);
  ...
  // starts with null
  public currentCategory = signal<DepositCategoryResponseDTO | null>(null);
  ...
  onEditCategory(category: DepositCategoryResponseDTO): void{
    this.currentCategory.set(category);
    this.isEditCategoryModalOpen.set(true);
    this.nameControl.setValue(category.name);
  }
  
  onDeleteCategory(category: DepositCategoryResponseDTO):void{
